...
uint8_t GRAPHICS_COMIC[][16*32*4] =
  {
    "assets/comic_standing_right_16x32m.ega",
    "assets/comic_running_1_right_16x32m.ega",
    "assets/comic_running_2_right_16x32m.ega",
    "assets/comic_running_3_right_16x32m.ega",
    "assets/comic_jumping_right_16x32m.ega",
    "assets/comic_standing_left_16x32m.ega",
    "assets/comic_running_1_left_16x32m.ega",
    "assets/comic_running_2_left_16x32m.ega",
    "assets/comic_running_3_left_16x32m.ega",
    "assets/comic_jumping_left_16x32m.ega",
  };


uint8_t GRAPHIC_FIREBALL_0[16*8*4] = "assets/fireball_0_16x8m.ega";
uint8_t GRAPHIC_FIREBALL_1[16*8*4] = "assets/fireball_1_16x8m.ega";

uint8_t GRAPHIC_WHITE_SPARK_0[16*16*4] = "assets/white_spark_0_16x16m.ega";
uint8_t GRAPHIC_WHITE_SPARK_1[16*16*4] = "assets/white_spark_1_16x16m.ega";
uint8_t GRAPHIC_WHITE_SPARK_2[16*16*4] = "assets/white_spark_2_16x16m.ega";

uint8_t GRAPHIC_RED_SPARK_0[16*16*4] = "assets/red_spark_0_16x16m.ega";
uint8_t GRAPHIC_RED_SPARK_1[16*16*4] = "assets/red_spark_1_16x16m.ega";
uint8_t GRAPHIC_RED_SPARK_2[16*16*4] = "assets/red_spark_2_16x16m.ega";

uint8_t ANIMATION_COMIC_DEATH[][16*32*4] =
  {
    "assets/comic_death_0_16x32m.ega",
    "assets/comic_death_1_16x32m.ega",
    "assets/comic_death_2_16x32m.ega",
    "assets/comic_death_3_16x32m.ega",
    "assets/comic_death_4_16x32m.ega",
    "assets/comic_death_5_16x32m.ega",
    "assets/comic_death_6_16x32m.ega",
    "assets/comic_death_7_16x32m.ega",
  };

uint8_t GRAPHIC_TELEPORT_0[16*32*4] = "assets/teleport_0_16x32m.ega";
uint8_t GRAPHIC_TELEPORT_1[16*32*4] = "assets/teleport_1_16x32m.ega";
uint8_t GRAPHIC_TELEPORT_2[16*32*4] = "assets/teleport_2_16x32m.ega";

uint8_t ANIMATION_MATERIALIZE[][16*32*4] =
  {
    "assets/materialize_0_16x32m.ega",
    "assets/materialize_1_16x32m.ega",
    "assets/materialize_2_16x32m.ega",
    "assets/materialize_3_16x32m.ega",
    "assets/materialize_4_16x32m.ega",
    "assets/materialize_5_16x32m.ega",
    "assets/materialize_6_16x32m.ega",
    "assets/materialize_7_16x32m.ega",
    "assets/materialize_8_16x32m.ega",
    "assets/materialize_9_16x32m.ega",
    "assets/materialize_10_16x32m.ega",
    "assets/materialize_11_16x32m.ega",
  };
...
uint8_t GRAPHIC_CORKSCREW_EVEN[16*16*4] = "assets/corkscrew_even_16x16m.ega";
uint8_t GRAPHIC_DOOR_KEY_EVEN[16*16*4] = "assets/door_key_even_16x16m.ega";
uint8_t GRAPHIC_BOOTS_EVEN[16*16*4] = "assets/boots_even_16x16m.ega";
uint8_t GRAPHIC_LANTERN_EVEN[16*16*4] = "assets/lantern_even_16x16m.ega";
uint8_t GRAPHIC_TELEPORT_WAND_EVEN[16*16*4] = "assets/teleport_wand_even_16x16m.ega";
uint8_t GRAPHIC_GEMS_EVEN[16*16*4] = "assets/gems_even_16x16m.ega";
uint8_t GRAPHIC_CROWN_EVEN[16*16*4] = "assets/crown_even_16x16m.ega";
uint8_t GRAPHIC_GOLD_EVEN[16*16*4] = "assets/gold_even_16x16m.ega";
uint8_t GRAPHIC_BLASTOLA_COLA_EVEN[][16*16*4] =
  {
    "assets/blastola_cola_even_16x16m.ega",
    "assets/blastola_cola_inventory_1_even_16x16m.ega",
    "assets/blastola_cola_inventory_2_even_16x16m.ega",
    "assets/blastola_cola_inventory_3_even_16x16m.ega",
    "assets/blastola_cola_inventory_4_even_16x16m.ega",
    "assets/blastola_cola_inventory_5_even_16x16m.ega",
    "assets/shield_even_16x16m.ega", // TODO: investigate
  };
uint8_t GRAPHIC_LIFE_ICON_EVEN[16*16*4] = "assets/life_icon_bright_16x16m.ega";


uint8_t GRAPHIC_CORKSCREW_ODD[16*16*4] = "assets/corkscrew_odd_16x16m.ega";
uint8_t GRAPHIC_DOOR_KEY_ODD[16*16*4] = "assets/door_key_odd_16x16m.ega";
uint8_t GRAPHIC_BOOTS_ODD[16*16*4] = "assets/boots_odd_16x16m.ega";
uint8_t GRAPHIC_LANTERN_ODD[16*16*4] = "assets/lantern_odd_16x16m.ega";
uint8_t GRAPHIC_TELEPORT_WAND_ODD[16*16*4] = "assets/teleport_wand_odd_16x16m.ega";
uint8_t GRAPHIC_GEMS_ODD[16*16*4] = "assets/gems_odd_16x16m.ega";
uint8_t GRAPHIC_CROWN_ODD[16*16*4] = "assets/crown_odd_16x16m.ega";
uint8_t GRAPHIC_GOLD_ODD[16*16*4] = "assets/gold_odd_16x16m.ega";
uint8_t GRAPHIC_BLASTOLA_COLA_ODD[][16*16*4] =
  {
    "assets/blastola_cola_odd_16x16m.ega",
    "assets/blastola_cola_inventory_1_odd_16x16m.ega",
    "assets/blastola_cola_inventory_2_odd_16x16m.ega",
    "assets/blastola_cola_inventory_3_odd_16x16m.ega",
    "assets/blastola_cola_inventory_4_odd_16x16m.ega",
    "assets/blastola_cola_inventory_5_odd_16x16m.ega",
    "assets/shield_odd_16x16m.ega",
  };
uint8_t GRAPHIC_LIFE_ICON_ODD[16*16*4] = "assets/life_icon_dark_16x16m.ega";

uint8_t GRAPHICS_SCORE_DIGITS[10][8*16*4] =
  {
    "assets/score_digit_0_8x16.ega",
    "assets/score_digit_1_8x16.ega",
    "assets/score_digit_2_8x16.ega",
    "assets/score_digit_3_8x16.ega",
    "assets/score_digit_4_8x16.ega",
    "assets/score_digit_5_8x16.ega",
    "assets/score_digit_6_8x16.ega",
    "assets/score_digit_7_8x16.ega",
    "assets/score_digit_8_8x16.ega",
    "assets/score_digit_9_8x16.ega",
  };

uint8_t GRAPHIC_METER_EMPTY[8*16*4] = "assets/meter_empty_8x16.ega";
uint8_t GRAPHIC_METER_HALF[8*16*4] = "assets/meter_half_8x16.ega";
uint8_t GRAPHIC_METER_FULL[8*16*4] = "assets/meter_full_8x16.ega";

uint8_t GRAPHIC_PAUSE[128*48*4] = "assets/pause_128x48.ega";

uint8_t GRAPHIC_GAME_OVER[128*48*4] = "assets/game_over_128x48.ega";

uint8_t TITLE_GRAPHIC[320*200*4] = "assets/SYS000.EGA";
uint8_t UI_GRAPHIC[320*200*4] = "assets/SYS003.EGA";
uint8_t STORY_GRAPHIC[320*200*4] = "assets/SYS001.EGA";
uint8_t ITEMS_GRAPHIC[320*200*4] = "assets/SYS004.EGA";
uint8_t WIN_GRAPHIC[320*200*4] = "assets/SYS002.EGA";
...
typedef struct
{
  ...
  int8_t x_vel;
  int8_t y_vel;
  int8_t spawn_timer_and_animation;	// when the enemy is not spawned, the counter until it spawns; when spawned, the animation counter
  uint8_t num_animation_frames;
  uint8_t behavior;
  uint8_t** animation_frames_ptr;
...
typedef struct
{
  char tt2_filename[20];
  char pt0_filename[20];
  char pt1_filename[20];
  char pt2_filename[20];
